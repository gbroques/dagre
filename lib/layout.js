...
function layout(g, opts) {
  console.log('gbroques/dagre fork');
...
function runLayout(g, time, opts) {
  ...
  // TODO: It's not clear whether we need the nestingGraph
  // It seems related to subgraphs or compound graphs which
  // don't seem to be fully supported. Furthermore, we remove
  // this after injecting edge label proxies which doesn't use the dummy root.
...
let graphAttrs = ["rankdir", "align"];
let nodeNumAttrs = ["width", "height", "rank"];
let nodeDefaults = { width: 0, height: 0, rank: 0 };
